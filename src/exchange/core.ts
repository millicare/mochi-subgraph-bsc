...
import { updatePairDayData, updateTokenDayData, updateMochiDayData, updatePairHourData } from "./dayUpdates";
...
export function handleTransfer(event: Transfer): void {
  ...
  let factory = MochiFactory.load(FACTORY_ADDRESS);
...
export function handleSwap(event: Swap): void {
  ...
  let pancakeDayData = updateMochiDayData(event);
